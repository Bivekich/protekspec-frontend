          ...
          <div className="px-5 md:px-20 flex flex-col lg:flex-row justify-between gap-10 lg:gap-20">
            ...
            >
              <form onSubmit={handleSubmit} className="flex flex-col w-full">
                <div className="flex flex-col lg:flex-row flex-wrap gap-5 lg:gap-10 justify-between w-full">
                ...
                <div className="flex flex-col mt-5 w-full">
                  ...
                  <textarea
                    ...
                    disabled={isSubmitting}
                    className="overflow-hidden gap-2.5 self-stretch px-3.5 py-4 mt-2.5 w-full text-sm font-light border-b border-solid border-b-[#FAC612] min-h-[50px] text-[#828282] bg-[#1A1A1A] placeholder:text-[#828282] focus:outline-none"
                    rows={3}
                  />
                </div>
                ...
                <div className="mt-5">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#FAC612] text-[#1A1A1A] py-5 mt-2.5 rounded-md hover:bg-[#FAC612]/80 transition-colors text-base font-bold uppercase focus:outline-none"
                  >
                    Отправить
                  </button>
                </div>
