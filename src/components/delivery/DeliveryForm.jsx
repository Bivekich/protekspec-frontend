              ...
              <form onSubmit={handleSubmit} className="flex flex-col w-full">
                ...
                <div className="flex flex-col mt-5 w-full">
                  ...
                  <textarea
                    ...
                    disabled={isSubmitting}
                    className="focus:outline-none overflow-hidden gap-2.5 self-stretch px-3.5 py-4 mt-2.5 w-full text-sm font-light border-b border-solid border-b-[#FAC612] min-h-[50px] text-[#828282] bg-[#1A1A1A] placeholder:text-[#828282]"
                    rows={3}
                  />
                </div>
