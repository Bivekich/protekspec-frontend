        ...
        >
          {brands.map((brand, index) => (
            <motion.div
              ...
              className="flex items-center justify-center p-1 bg-white hover:shadow-lg hover:border-[#FAC612] transition-all duration-200 aspect-[21/9] group cursor-pointer"
            >
              {brand.website ? (
                <a
                  href={brand.website}
